function [longy,laty,U,V,Uo,Vo,tempy,tempyy] = rescale(day)
lat = ncread('hycom_expt_91.1phil_2014-05-03.nc','Latitude');
lon = ncread('hycom_expt_91.1phil_2014-05-03.nc','Longitude');
tempo = ncread(['hycom_expt_91.1phil_2014-05-' num2str(day-1) '.nc'], 'temperature'); 
temp = ncread(['hycom_expt_91.1phil_2014-05-' num2str(day) '.nc'], 'temperature');
uvelo = ncread(['hycom_expt_91.1phil_2014-05-' num2str(day-1) '.nc'], 'u');
uvel = ncread(['hycom_expt_91.1phil_2014-05-' num2str(day) '.nc'], 'u');
vvelo = ncread(['hycom_expt_91.1phil_2014-05-' num2str(day-1) '.nc'], 'v');
vvel = ncread(['hycom_expt_91.1phil_2014-05-' num2str(day) '.nc'], 'v');
xvel = uvel(:,:,2);
yvel = vvel(:,:,2);
xvelo = uvelo(:,:,2);
yvelo = vvelo(:,:,2);
